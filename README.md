...
- To reduce the current, [solder 2k resistor](/Images/pcb_mod1.jpg) in parallel to R40. Resulting current is about 1.3A.
- To reduce the voltage, adjust the VR pot.

The unused IC6B op amp is left unconnected, not a good idea, even though it does not appear to oscillate at the time of this test. Short C19 and R18 to make it safe.<br>
